...
const Projects: React.FC = () => {
  ...
  const getTagColor = (tag: string) => {
    const tagColors: Record<string, string> = {
      ...
      JavaScript: 'bg-blue-400/20 text-blue-300 border-blue-400/20',
      Tauri: 'bg-cyan-600/20 text-cyan-300 border-cyan-600/20',
      MongoDB: 'bg-blue-700/20 text-blue-300 border-blue-700/20',
      Redis: 'bg-sky-500/20 text-sky-300 border-sky-500/20',
